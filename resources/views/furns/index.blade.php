...
@section('content')
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block">
                        ...
                        <div class="text-justify media-body p-2 mt-3">
                            ...
                            <p>CONDESIGN luôn tôn trọng tối đa cá tính và ý kiến của bạn trong từng thiết kế với gói tư vấn,
                                gợi ý lựa chọn phong cách nội thất phù hợp, gắn liền với sở thích và các sản phẩm trang trí
                                trong tổ ấm.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block">
                        ...
                        <div class=" text-justify media-body p-2 mt-3">
                            ...
                            <p>Với kinh nghiệm nhiều năm hoạt động trong lĩnh vực thi công nội/ngoại thất, CONDESIGN tự tin
                                sẽ mang đến những giải pháp thiết kế được cập nhật mới, mang phong cách riêng cùng chất
                                lượng thi công cao nhất, tạo nên sự trải nghiệm khác biệt dành cho khách hàng.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block">
                        ...
                        <div class="text-justify  media-body p-2 mt-3">
                            ...
                            <p>CONDESIGN luôn đề cao trải nghiệm của mỗi gia đình với tầm nhìn chiến lược trở thành Đơn vị
                                hàng đầu trong lĩnh vực Thiết kế & Thi công nội/ngoại thất tại Việt Nam.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="project">
                            <a href="{{ route('furn.projects.detail', $project['id']) }}">
                                <img src="{{ URL::asset('/uploads/' . $project['img']) }}" class="img-fluid"
                ...
                @foreach ($hot as $project)
                    <div class="col-md-4 ftco-animate">
                        <div class="blog-entry">
                            <a href="{{ route('furn.projects.detail', $project['id']) }}" class="block-20"
                                style="background-image: url({{ URL::asset('/uploads/' . $project['img']) }});">
                            </a>
    ...
    <section class="ftco-section ftc-no-pb">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-5 p-md-5 img img-2 order-md-last height-re"
