...
<section class="ftco-section">
    <div class="container-fluid">
        <div class="row no-gutters">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <img src="{{ asset('assets/decor/images/work-5.jpg') }}" class="img-fluid" alt="Colorlib Template">
                    <div class="text">
                        <h3>Office Interior Design in Paris</h3>
                    </div>
                    <a href="{{ asset('assets/decor/images/work-5.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
                        <span class="icon-expand"></span>
                    </a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <img src="{{ asset('assets/decor/images/work-6.jpg') }}" class="img-fluid" alt="Colorlib Template">
                    <div class="text">
                        <h3>Office Interior Design in Paris</h3>
                    </div>
                    <a href="{{ asset('assets/decor/images/work-6.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
                        <span class="icon-expand"></span>
                    </a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <img src="{{ asset('assets/decor/images/work-7.jpg') }}" class="img-fluid" alt="Colorlib Template">
                    <div class="text">
                        <h3>Office Interior Design in Paris</h3>
                    </div>
                    <a href="{{ asset('assets/decor/images/work-7.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
                        <span class="icon-expand"></span>
                    </a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <img src="{{ asset('assets/decor/images/work-8.jpg') }}" class="img-fluid" alt="Colorlib Template">
                    <div class="text">
                        <h3>Office Interior Design in Paris</h3>
                    </div>
                    <a href="{{ asset('assets/decor/images/work-8.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
                        <span class="icon-expand"></span>
                    </a>
                </div>
            </div>
